...
// Static file serving moved to very beginning before any middleware
...
app.use(reportPayrollErrors);
app.use(reportAuthErrors);
app.use(reportAPIErrors);
...
(async () => {
  ...
  // Global error handling middleware with email alerts
