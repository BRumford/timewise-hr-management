    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{stats?.pendingOnboarding || 0}</p>
          ...
          <Button className="mt-4 w-full bg-primary hover:bg-blue-700">
            View Pending
          </Button>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="p-6">
          ...
          <Button className="mt-4 w-full bg-accent hover:bg-green-700">
            Review Requests
          </Button>
        </CardContent>
      </Card>
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{stats?.todaySubstituteAssignments || 0}</p>
